...
class _SortToggleTable(QTableWidget):
    ...
    def __init__(self, rows: int, cols: int, parent=None):
        ...
        # Show the vertical scrollbar only when rows actually overflow — most
        # categories fit without scrolling, and a permanent track reads as
        # clutter. With the middle columns fixed, a scrollbar appearing only
        # nudges the two stretch columns by a few px rather than shifting all.
